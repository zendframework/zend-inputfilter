...
class PsrFileInputTest extends InputTest
{
    ...
    {
        $this->markTestSkipped('Test are not enabled in PsrFileInputTest');
    }
    ...
    public function isRequiredVsAllowEmptyVsContinueIfEmptyVsIsValidProvider()
    {
        ...
        // PsrFileInput do not use NotEmpty validator so the only validator present in the chain is the custom one.
